void spec_builder_example() {
  ...
  particle_spec_builder.add_particle_spec(NP::ParticleSpec{
      NP::ParticleProp(NP::Sym<NP::REAL>("w"), 1, false),
      NP::ParticleProp(NP::Sym<NP::REAL>("NEW_PROP"), 2, false)});
